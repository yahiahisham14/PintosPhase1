...
sub read_loader {
    my ($name) = @_;
<<<<<<< HEAD
    $name = find_file ("/home/fush/Pintos/pintos/src/threads/build/loader.bin") if !defined $name;
=======
    $name = find_file ("/home/omar/pintos/src/threads/build/loader.bin") if !defined $name;
>>>>>>> 600a3fc033d0a881efc51e07ce7e703a10e1f634
